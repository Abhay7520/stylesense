...
import { Upload, X, Camera, Sparkles, ArrowRight } from 'lucide-react'
                ...
                <>
                  <label htmlFor="file-upload" style={{ display: 'block', cursor: 'pointer' }}>
                    ...
                    >
                      ...
                      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 300, color: 'rgba(245,240,235,0.35)', margin: 0 }}>
                        your image to begin
                      </p>
