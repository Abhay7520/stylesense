                  ...
                  {!originalImage ? (
                    <motion.div key="upload" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                      <label className="file-input-wrapper" style={{ display: 'block' }}>
                        ...
                        <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 20, fontWeight: 300, margin: '0 0 8px' }}>
                          Upload Your Photo
                        </p>
                        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, fontWeight: 300, color: 'rgba(245,240,235,0.3)', margin: 0 }}>
                    ...
                    <motion.div key="configure" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                      ...
                      <div style={{ display: 'flex', gap: 12 }}>
                        <button
                          ...
                          disabled={!selectedOutfit || isGenerating}
              ...
              <motion.div variants={fadeUp} className="panel">
                ...
                {steps.map((step, i) => (
                  <div key={step.num} className="step-row">
                    <span style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 28, fontWeight: 300, color: 'rgba(245,240,235,0.15)', lineHeight: 1, minWidth: 36 }}>
                      {step.num}
                    </span>
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 13, fontWeight: 300, color: 'rgba(245,240,235,0.5)', margin: 0, lineHeight: 1.7, paddingTop: 4 }}>
                      {step.text}
                    </p>
                  </div>
                ))}
                ...
                {isGenerating ? (
                  ...
                  >
                    ...
                    <div style={{ textAlign: 'center' }}>
                      <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 300, margin: '0 0 8px' }}>
                        Generating your look…
                      </p>
                      <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 12, color: 'rgba(245,240,235,0.3)', margin: 0, letterSpacing: '0.05em' }}>
                  ...
                  >
                    ...
                    <div style={{ display: 'flex', gap: 12 }}>
                      ...
                      <button onClick={handleGenerateTryOn} className="btn-ghost">
